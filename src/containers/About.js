			...
			<section className={styles.aboutFounder}>
				<Container maxWidth="xl" className={styles.founderContainer}>
					...
					<Grid
						...
						spacing={4}
					>
						<Grid size={{ sm: 12, md: 4 }} className={styles.founderColumn}>
							<div
								className={styles.founderImage}
								onClick={() => handleModalOpen('kunal')}
							>
							...
							<div className={styles.name}>Kunal Jaggi</div>
							<div className={styles.designation}>
								Founder & CEO, Glocal LPO
							</div>
							<div className={styles.description}>
								Kunal Jaggi, the force behind Glocal LPO, blends 20+ years of
								global outsourcing leadership with a sharp eye for legal
								innovation. As a people-first visionary, he's redefining legal
								support with precision, passion, and purpose.
							</div>
						...
						<Grid size={{ sm: 12, md: 4 }} className={styles.founderColumn}>
							<div
								className={styles.founderImage}
								onClick={() => handleModalOpen('srishti')}
							>
							...
							<div className={styles.name}>Srishti Khatri</div>
							<div className={styles.designation}>
								VP - Sales & Marketing, Glocal LPO
							</div>
							<div className={styles.description}>
								Srishti drives growth at Glocal LPO through strategic
								partnerships and sharp marketing expertise, strengthening brand
								presence and business expansion.
							</div>
							<div className={styles.socialFootprint}>
								<a
						...
						<Grid size={{ sm: 12, md: 4 }} className={styles.founderColumn}>
							<div
								className={styles.founderImage}
								onClick={() => handleModalOpen('deepti')}
							>
							...
							<div className={styles.name}>Deepti Sisodiya</div>
							<div className={styles.designation}>
								Business Head. Glocal LPO
							</div>
							<div className={styles.description}>
								Deepti, Glocal LPO's Business Head, turns vision into impact.
								With sharp sales and marketing acumen, she leads 180+ legal
								pros, driving growth and delivering tailored, scalable
								solutions. A resilient leader and proud defense brat, Deepti
								blends insight with discipline to make Glocal your trusted legal
								partner.
							</div>
							<div className={styles.socialFootprint}>
								<a
